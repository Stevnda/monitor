        ...
        <el-image
          ...
          :src="
            buoyInfo === undefined
              ...
              : buoyInfo.hbphoto === ''
              ? '/buoy-no.png'
              : '/monitor/waterway/img/' + buoyInfo.photo
          "
          :preview-src-list="[
            buoyInfo === undefined
              ? ''
      ...
      <el-col :span="14" id="buoy-text">
        ...
        >
          <el-descriptions-item
            ...
            align="center"
            >{{
              buoyInfo === undefined ? "" : buoyInfo.name
            }}</el-descriptions-item
          >
          <el-descriptions-item
            label="颜色"
            ...
            align="center"
            >{{
              buoyInfo === undefined ? "" : buoyInfo.color
            }}</el-descriptions-item
          >
          <el-descriptions-item
            label="形状"
            ...
            align="center"
          >
            {{ buoyInfo === undefined ? "" : buoyInfo.shape }}
          </el-descriptions-item>
          <el-descriptions-item
            label="所属航道"
            label-align="center"
            align="center"
          >
            {{ buoyInfo === undefined ? "" : buoyInfo.waterway }}
          </el-descriptions-item>
        </el-descriptions>
      </el-col>
    </el-row>
...
import { BuoyType } from "@/type";
export default defineComponent({
  props: {
    buoyInfo: {
      type: Object as PropType<BuoyType>,
    },
  },
  setup(props) {
