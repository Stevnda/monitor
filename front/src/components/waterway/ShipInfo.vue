    ...
    <el-card shadow="hover">
      <template #header>
        <div class="card-header">
          <span class="ship-name">{{
            shipInfo === undefined ? "" : shipInfo.name + "-" + shipInfo.nameCn
          }}</span>
          <br />
      ...
      <el-descriptions direction="vertical" :column="4" size="large" border>
        <el-descriptions-item
          ...
          align="center"
          >{{
            shipInfo === undefined ? "" : shipInfo.speed + "km/h"
          }}</el-descriptions-item
        >
        <el-descriptions-item
          label="航向"
          ...
          align="center"
          >{{
            shipInfo === undefined ? "" : shipInfo.course + "°"
          }}</el-descriptions-item
        >
        <el-descriptions-item
          label="MMSI"
        ...
        <el-descriptions-item
          ...
          align="center"
        >
          {{ shipInfo === undefined ? "" : shipInfo.updateTime }}
        </el-descriptions-item>
      </el-descriptions>
    </el-card>
...
import { ShipType } from '@/type'
export default defineComponent({
  props: {
    shipInfo: {
      type: Object as PropType<ShipType>,
    },
  },
  setup(props) {
