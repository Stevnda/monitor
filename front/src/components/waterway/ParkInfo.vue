  ...
  <div id="park-info">
    <el-descriptions direction="horizontal" :column="2" size="default" border>
      <el-descriptions-item label="名称" label-align="center" align="center">{{
        parkInfo === undefined ? "" : parkInfo.name
      }}</el-descriptions-item>
      <el-descriptions-item label="用途" label-align="center" align="center">{{
        parkInfo === undefined ? "" : parkInfo.usage
      }}</el-descriptions-item>
      <el-descriptions-item
        label="管理单位"
        label-align="center"
        align="center"
        >{{
          parkInfo === undefined ? "" : parkInfo.management
        }}</el-descriptions-item
      >
      <el-descriptions-item
        label="水道名称"
        ...
        align="center"
        >{{
          parkInfo === undefined ? "" : parkInfo.waterwayName
        }}</el-descriptions-item
      >
    </el-descriptions>
...
import { ParkType } from "@/type";
export default defineComponent({
  props: {
    parkInfo: {
      type: Object as PropType<ParkType>,
    },
  },
  setup(props) {
    const parkInfo = computed(() => {
      return props.parkInfo;
    });
